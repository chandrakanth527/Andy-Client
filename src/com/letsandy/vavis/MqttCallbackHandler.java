...
public class MqttCallbackHandler implements MqttCallback {
	...
	public void connectionLost(Throwable cause) {
		...
		if (cause != null) {
			...
			broadcastIntent.setAction("com.letsandy.connectionLostMQTT");
	...
	public void messageArrived(String topic, MqttMessage message) throws Exception {
		...
		// (Object[]) args);
		String messageString = "Message Arrived " + args[0];
		...
		Intent broadcastIntent = new Intent();
		broadcastIntent.setAction("com.letsandy.messageArrivedMQTT");
		broadcastIntent.putExtra("TOPIC", topic);
		broadcastIntent.putExtra("MESSAGE", new String(message.getPayload()));
